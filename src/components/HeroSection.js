      ...
      <div className="hero-section-wrapper">
        <div className="hero-content">
          ...
          <p className="hero-subheading">
            <strong>Driving 40% more leads</strong> with SEO-ready websites that load in under 2 seconds.
            Transforming visions into exceptional digital experiences that <strong>convert visitors into customers</strong>.
          </p>

          <p className="hero-description">
            As a full-stack designer and developer with over 5 years of experience, I specialize in creating
            digital solutions that deliver measurable business results...
          </p>

          <div className="hero-buttons">
            <a href="#quote" className="btn primary">Get a Quote</a>
            <Link to="/ux-audit" className="btn secondary">Free UX Audit</Link>
          </div>
        </div>

        <div className="hero-visual">
          <div className="hero-image-stack">
            <img src={heroImage} alt="Rajiv Ranjan" className="hero-photo" />
            ...
            <div className="hero-testimonial-card">
              ...
              <div className="hero-stars">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="hero-star" viewBox="0 0 20 20" fill="currentColor">
